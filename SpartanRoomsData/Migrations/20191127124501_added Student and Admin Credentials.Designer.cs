...
namespace SpartanRoomsData.Migrations
{
    ...
    [Migration("20191127124501_added Student and Admin Credentials")]
    partial class addedStudentandAdminCredentials
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SpartanRoomsData.Models.AdminCredentials", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("SpartanRoomsData.Models.StudentCredentials", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("SpartanRoomsData.Models.AdminCredentials", b =>
                {
                    b.HasOne("SpartanRoomsData.Models.Admin", "Admin")
                        .WithMany()
